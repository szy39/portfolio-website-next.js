     ...
     <div className="col-span-7 place-self-center text-center sm:text-left ">
      ...
      <span className='text-transparent bg-clip-text bg-gradient-to-r from-blue-500 via-purple-500 to-pink-600'>
       ...
       <p className='text-[#adb7be] text-base sm:text-lg mb-6 lg:text-xl'>
         ...
         <div>
          <button className='px-6 py-3 w-full sm:w-fit rounded-full mr-4 bg-gradient-to-br from-blue-500 via-purple-500 to-pink-500  text-white font-semibold '>Hire Me !</button>
          <button className='px-1 py-1 w-full sm:w-fit rounded-full mr-4 bg-gradient-to-br from-blue-500 via-purple-500 to-pink-500  text-white  mt-3 font-semibold'>
